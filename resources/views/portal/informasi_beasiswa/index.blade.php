...
@section('title', 'Informasi Beasiswa - Teknik Elektro UNTAN')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="blog_3_wrap">
                                                ...
                                                <div class="blog_3_des">
                                                    <figure>
                                                        <img  style="height : 20rem; object-fit :cover"  src="{{ url($informasiBeasiswa->thumbnail) }}" alt="" />
                                                        <figcaption><a href="{{ url($informasiBeasiswa->slug) }}"><i class="fa fa-search-plus"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                    <h5><a href="{{ url($informasiBeasiswa->slug) }}">{{ $informasiBeasiswa->judul }}</a></h5>
                                                    <li><i class="fa fa-calendar"></i>  {{ date(' Y', strtotime($informasiBeasiswa->release_date)) }}</li>
                                                    <p>
