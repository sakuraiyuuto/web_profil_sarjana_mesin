                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Detail Jadwal Seminar Hasil</h3>
                        </div>

                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a href="{{ url('/jadwal_seminar_hasil') }}">Jadwal Seminar Hasil</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>Jadwal Seminar Hasil Semester {{ $jadwalSeminarHasil->semester }} Tahun Akademik
                                        {{ $jadwalSeminarHasil->tahun_ajaran }}</h5>
                                </div>

                                <p>Dokumen :</p>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <object data="{{ url($jadwalSeminarHasil->nama_file) }}" type="application/pdf">
                                        <iframe
