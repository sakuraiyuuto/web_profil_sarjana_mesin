                    ...
                    <div class="kf_inr_ban_des">
                        ...
                        <div class="kf_inr_breadcrumb">
                            <ul>
                                ...
                                <li><a href="{{ url('/lowongan_pekerjaan') }}">Lowongan Pekerjaan</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($lowonganPekerjaan->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Lowongan Pekerjaan</a></figcaption>
                                </figure>
                            </div>
