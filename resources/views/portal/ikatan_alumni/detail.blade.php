...
@section('title', 'Ikatan Alumni - Teknik Mesin UNTAN')
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($ikatanAlumni->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Ikatan Alumni</a></figcaption>
                                </figure>
                            </div>
                            ...
                            <ul class="contact_meta">
                                <li><a href="{{ url($ikatanAlumni->url_facebook) }}"><i style="font-size : 20px"
                                            class="fa fa-facebook-square"></i><b>
                                            {{ $ikatanAlumni->facebook }} </a> </b></li>
                                <li><a href="{{ url($ikatanAlumni->url_instagram) }}"><i style="font-size : 20px"
                                            class="fa fa-instagram"></i><b>
                                            {{ $ikatanAlumni->instagram }}</a> </b></li>
                                <li><a href="{{ url($ikatanAlumni->url_youtube) }}"><i style="font-size : 20px"
                                            class="fa fa-youtube-play"></i> <b>
                                            {{ $ikatanAlumni->youtube }}</a> </b></li>
                                <li><a href="{{ url($ikatanAlumni->url_twitter) }}"><i style="font-size : 20px"
                                            class="fa fa-twitter-square"></i><b>
                                            {{ $ikatanAlumni->twitter }}</a> </b></li>
                            </ul>
