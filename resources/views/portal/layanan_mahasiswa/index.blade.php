                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="blog_3_wrap">
                                                ...
                                                <div class="blog_3_des">
                                                    <figure>
                                                        <img style="height : 20rem;object-fit:cover" src="{{ url($layananMahasiswa->thumbnail) }}" alt="" />
                                                        <figcaption><a href="{{ url($layananMahasiswa->slug) }}"><i class="fa fa-search-plus"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                    <h5><a href="{{ url($layananMahasiswa->slug) }}">{{ $layananMahasiswa->judul }}</a></h5>
                                                    <li><i class="fa fa-calendar"></i>  {{ date(' Y', strtotime($layananMahasiswa->release_date)) }}</li>
                                                    <p>
