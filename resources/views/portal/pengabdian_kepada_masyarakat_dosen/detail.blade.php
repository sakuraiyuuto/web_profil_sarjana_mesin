...
@section('title', 'Pengabdian Kepada Masyarakat Dosen - Teknik Mesin UNTAN')
                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Detail Pengabdian Kepada Masyarakat Dosen</h3>
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($pengabdianKepadaMasyarakatDosen->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Pengabdian Kepada Masyarakat Dosen</a></figcaption>
                                </figure>
                            </div>
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $pengabdianKepadaMasyarakatDosen->judul }}</h5>
                                </div>
                                <ul class="blog_detail_meta">
                                    <li><i class="fa fa-calendar"></i><a
                                            href="#">{{ date('d M, Y', strtotime($pengabdianKepadaMasyarakatDosen->release_date)) }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Pelaku PKM : {{ $pengabdianKepadaMasyarakatDosen->author }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Tahun PKM : {{ $pengabdianKepadaMasyarakatDosen->tahun }}</a>
                                    </li>
                                </ul>

                                <p>{!! $pengabdianKepadaMasyarakatDosen->teks !!}
