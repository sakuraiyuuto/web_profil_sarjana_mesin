                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Pengabdian Kepada Masyarakat Dosen</h3>
                        </div>
                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a>Pengabdian Kepada Masyarakat Dosen</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        <table id="tabel_pengabdian_kepada_masyarakat" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Daftar Pengabdian Kepada Masyarakat Dosen</th>
                                </tr>
                            </thead>
                            <tbody>
                                                ...
                                                <div class="row" style="height : 10rem">
                                                        ...
                                                        <div class="kf_event_list_thumb">
                                                            <figure style="height : 13rem">
                                                                <img style="height : 15rem; width:100%; object-fit :cover"
                                                                    src="{{ url($pengabdianKepadaMasyarakatDosen->thumbnail) }}"
                                                                    alt="" />
                                                            </figure>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <div class="kf_event_list_des" style="padding: 10px 10px 10px 0;">
                                                            <h4><a
                                                                    href="{{ url($pengabdianKepadaMasyarakatDosen->slug) }}"><span>{{ $pengabdianKepadaMasyarakatDosen->judul }}</span></a>
                                                            </h4>
                                                            <ul class="kf_event_list_links">
                                                                <li><a>Pelaku PKM :
                                                                        {{ $pengabdianKepadaMasyarakatDosen->author }}</a>
                                                                </li><br>
                                                                <li><a>Tahun PKM :
                                                                        {{ $pengabdianKepadaMasyarakatDosen->tahun }}</a>
                                                                </li>
                                                            </ul>
                                                            <a class="readmore"
                                                                href="{{ url($pengabdianKepadaMasyarakatDosen->slug) }}">
                                                                Selengkapnya
