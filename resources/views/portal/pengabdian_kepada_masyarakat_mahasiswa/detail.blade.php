                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Detail Pengabdian Kepada Masyarakat Mahasiswa</h3>
                        </div>

                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a href="{{ url('/pengabdian_kepada_masyarakat') }}">Pengabdian Kepada Masyarakat
                                        Mahasiswa</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($pengabdianKepadaMasyarakatMahasiswa->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Pengabdian Kepada Masyarakat Mahasiswa</a></figcaption>
                                </figure>
                            </div>
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $pengabdianKepadaMasyarakatMahasiswa->judul }}</h5>
                                </div>
                                <ul class="blog_detail_meta">
                                    <li><i class="fa fa-calendar"></i><a
                                            href="#">{{ date('d M, Y', strtotime($pengabdianKepadaMasyarakatMahasiswa->release_date)) }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Pelaku PKM : {{ $pengabdianKepadaMasyarakatMahasiswa->author }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Tahun PKM : {{ $pengabdianKepadaMasyarakatMahasiswa->tahun }}</a>
                                    </li>
                                </ul>

                                <p>{!! $pengabdianKepadaMasyarakatMahasiswa->teks !!}
