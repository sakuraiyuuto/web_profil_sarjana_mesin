...
@section('title', 'Pengabdian Kepada Masyarakat Mahasiswa - Teknik Mesin UNTAN')
                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Pengabdian Kepada Masyarakat Mahasiswa</h3>
                        </div>
                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a>Pengabdian Kepada Masyarakat Mahasiswa</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="kf_content_wrap">
        <section class="event_list_page">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <table id="tabel_pengabdian_kepada_masyarakat_mahasiswa" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Daftar Pengabdian Kepada Masyarakat Mahasiswa</th>
                                </tr>
                            </thead>
                            <tbody>
                                                ...
                                                <div class="row" style="height : 10rem">
                                                        ...
                                                        <div class="kf_event_list_thumb">
                                                            <figure style="height : 13rem">
                                                                <img style="height : 15rem; width:100%; object-fit :cover"
                                                                    src="{{ url($pengabdianKepadaMasyarakatMahasiswa->thumbnail) }}"
                                                                    alt="" />
                                                            </figure>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <div class="kf_event_list_des" style="padding: 10px 10px 10px 0;">
                                                            <h4><a
                                                                    href="{{ url($pengabdianKepadaMasyarakatMahasiswa->slug) }}"><span>{{ $pengabdianKepadaMasyarakatMahasiswa->judul }}</span></a>
                                                            </h4>
                                                            <ul class="kf_event_list_links">
                                                                <li><a>Pelaku PKM :
                                                                        {{ $pengabdianKepadaMasyarakatMahasiswa->author }}</a>
                                                                </li><br>
                                                                <li><a>Tahun PKM :
                                                                        {{ $pengabdianKepadaMasyarakatMahasiswa->tahun }}</a>
                                                                </li>
                                                            </ul>
                                                            <a class="readmore"
                                                                href="{{ url($pengabdianKepadaMasyarakatMahasiswa->slug) }}">
                                                                Selengkapnya
...
@section('script')
    <script>
        $(document).ready(function() {
            $('#tabel_pengabdian_kepada_masyarakat_mahasiswa').DataTable();
        });
    </script>
@endsection
