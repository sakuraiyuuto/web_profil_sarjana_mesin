...
@section('title', 'Kerjasama Mitra Kolaborasi - Teknik Elektro UNTAN')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="blog_3_wrap">
                                                ...
                                                <div class="blog_3_des">
                                                    <figure>
                                                        <img class="img-news"src="{{ url($kerjasamaMitraKolaborasi->thumbnail) }}" alt="" />
                                                        <figcaption><a href="{{ url($kerjasamaMitraKolaborasi->slug) }}"><i class="fa fa-search-plus"></i></a>
                                                        </figcaption>
                                                    </figure>
                                                    <h5><a href="{{ url($kerjasamaMitraKolaborasi->slug) }}">{{ $kerjasamaMitraKolaborasi->judul }}</a></h5>
                                                    <p>
