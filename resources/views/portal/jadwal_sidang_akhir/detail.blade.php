...
@section('title', 'Jadwal Sidang Akhir - Teknik Mesin UNTAN')
                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Detail Jadwal Sidang Akhir</h3>
                        </div>

                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a href="{{ url('/jadwal_kuliah') }}">Jadwal Sidang Akhir</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>Jadwal Sidang Akhir Semester {{ $jadwalSidangAkhir->semester }} Tahun Akademik
                                        {{ $jadwalSidangAkhir->tahun_ajaran }}</h5>
                                </div>

                                <p>Dokumen :</p>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <object data="{{ url($jadwalSidangAkhir->nama_file) }}" type="application/pdf">
                                        <iframe
