                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Data Penelitian</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    <!-- form start -->
                                    <form class="from-prevent-multiple-submits" action="{{ route('penelitian.store') }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="author" name="author"
                                                    placeholder="Masukkan Peneliti" value="" required maxlength="255">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="teks" placeholder="Masukkan Teks Penelitian" name="teks"
