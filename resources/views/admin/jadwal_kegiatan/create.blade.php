                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Data Jadwal Kegiatan</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="from-prevent-multiple-submits"
                                        action="{{ route('jadwal_kegiatan.store') }}" method="POST"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="author" name="author"
                                                    placeholder="Masukkan Pelaksana Kegiatan" value="" required maxlength="255">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="teks" placeholder="Masukkan Teks Jadwal Kegiatan"
