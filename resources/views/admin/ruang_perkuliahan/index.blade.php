    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Ruang Perkuliahan</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Menu Ruang Perkuliahan</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    <form class="from-prevent-multiple-submits"
                                        action="{{ route('ruang_perkuliahan.update', $ruangPerkuliahan->id) }}"
                                        method="POST">
                                        @method('patch')
                                        @csrf
                                        <textarea id="teks" placeholder="Enter the Description"
                                            name="teks">{{ $ruangPerkuliahan->teks }}</textarea>
                                        <br>
