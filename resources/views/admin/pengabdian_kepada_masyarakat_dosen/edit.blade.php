                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Data Pengabdian Kepada Masyarakat Dosen</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="from-prevent-multiple-submits"
                                        action="{{ route('pkm_dosen.update', $pengabdianKepadaMasyarakatDosen) }}"
                                        method="POST" enctype="multipart/form-data">
                                        @method('patch')
                                        @csrf
                                        <div class="card-body">
                                            <input type="hidden" value="{{ $pengabdianKepadaMasyarakatDosen->id }}"
                                                name="id">
                                            <div class="form-group">
                                                <label for="judul">Judul</label>
                                                <input type="text" class="form-control" id="judul" name="judul"
                                                    placeholder="Masukkan Judul"
                                                    value="{{ $pengabdianKepadaMasyarakatDosen->judul }}" maxlength="255"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="author" name="author"
                                                    ...
                                                    value="{{ $pengabdianKepadaMasyarakatDosen->author }}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="tahun">Tahun</label>
                                                <input type="number" class="form-control" id="tahun" name="tahun"
                                                    placeholder="Masukkan Tahun Penelitian"
                                                    value="{{ $pengabdianKepadaMasyarakatDosen->tahun }}" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="thumbnail">Thumbnail (Maksimal 2MB)</label>
                                                <div class="form-group">
                                                    <img src="{{ url($pengabdianKepadaMasyarakatDosen->thumbnail) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="teks" placeholder="Masukkan Deskripsi"
                                                    name="teks">{{ $pengabdianKepadaMasyarakatDosen->teks }}</textarea>
                                            </div>
                                            <div class="form-group mt-2">
                                                <label for="release_date">Tanggal Rilis</label>
                                                <input type="date" class="form-control mt-0" name="release_date"
                                                    value="{{ $pengabdianKepadaMasyarakatDosen->release_date }}" required>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
