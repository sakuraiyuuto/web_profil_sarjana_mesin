                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Data Pengabdian Kepada Masyarakat Dosen</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    <!-- form start -->
                                    <form class="from-prevent-multiple-submits" action="{{ route('pkm_dosen.store') }}"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="teks"
                                                    placeholder="Masukkan Teks Pengabdian Kepada Masyarakat Dosen"
