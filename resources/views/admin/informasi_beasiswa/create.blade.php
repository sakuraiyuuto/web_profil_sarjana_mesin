                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Tambah Data Informasi Beasiswa</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="from-prevent-multiple-submits"
                                        action="{{ route('informasi_beasiswa.store') }}" method="POST" id="ckeditorForm"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="teks" placeholder="Masukkan Teks Informasi Beasiswa"
