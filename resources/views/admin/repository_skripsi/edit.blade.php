                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Data Repository Skripsi</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form class="from-prevent-multiple-submits"
                                        action="{{ route('repository_skripsi.update', $repositorySkripsi) }}"
                                        method="POST" enctype="multipart/form-data">
                                        @method('patch')
                                        @csrf
                                        <div class="card-body">
                                            <input type="hidden" value="{{ $repositorySkripsi->id }}" name="id">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="author" name="author"
                                                    placeholder="Masukkan Author" value="{{ $repositorySkripsi->author }}"
                                                    required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="teks" placeholder="Masukkan Deskripsi"
                                                    name="teks">{{ $repositorySkripsi->teks }}</textarea>
                                            </div>
                                            <div class="form-group mt-2">
                                                <label for="release_date">Tanggal Rilis</label>
                                                <input type="date" class="form-control mt-0" name="release_date"
                                                    value="{{ $repositorySkripsi->release_date }}" required>
                                            </div>
                                        </div>
                                        <!-- /.card-body -->
