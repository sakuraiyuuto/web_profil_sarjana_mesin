...
class CreateIkatanAlumnisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ikatan_alumnis', function (Blueprint $table) {
            $table->id();
        ...
        DB::table('ikatan_alumnis')->insert(
            array(
                [
                    'nama' => 'Ikatan Alumni Teknik Mesin',
                    ...
                    'facebook' => "Ikatan Alumni Mesin Facebook",
                    'url_facebook' => "https://www.facebook.com/",
                    'instagram' => "Ikatan Alumni Mesin Instagram",
                    'url_instagram' => "https://www.instagram.com/",
                    'youtube' => "Ikatan Alumni Mesin Youtube",
                    'url_youtube' => "https://www.youtube.com/",
                    'twitter' => "Ikatan Alumni Mesin Twitter",
